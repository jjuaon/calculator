...
HD_PWD='C:/Users/sosolitary/.Xilinx/calculator/calculator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_display.tcl
