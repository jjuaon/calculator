...
HD_PWD='C:/Users/sosolitary/.Xilinx/calculator/calculator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_display.tcl -notrace
